...
GRALLOC_USE_LEGACY_ION_API:=1
$(warning GRALLOC_USE_LEGACY_ION_API is $(GRALLOC_USE_LEGACY_ION_API))
...
LOCAL_SHARED_LIBRARIES := libhardware liblog libcutils libGLESv1_CM libion libsync libutils
    ...
    ifeq ($(GRALLOC_MAPPER), 1)
        LOCAL_SHARED_LIBRARIES := libhardware libhidlbase libhidltransport liblog libcutils libion libsync libutils
