...
#ifndef ANDROID_HARDWARE_GRAPHICS_V3_X_GRALLOCBUFFERDESCRIPTOR_H
#define ANDROID_HARDWARE_GRAPHICS_V3_X_GRALLOCBUFFERDESCRIPTOR_H
 ...
 *
 * @param descriptorInfo [in]  Specifies the (3.0 IMapper) attributes of
 *                             the descriptor.
 *
 * @return Newly created buffer descriptor;
 */
inline V3_0::BufferDescriptor grallocEncodeBufferDescriptor(
       const V3_0::IMapper::BufferDescriptorInfo& descriptorInfo)
{
	V3_0::BufferDescriptor descriptor;
 ...
 */
inline bool grallocDecodeBufferDescriptor(const V3_0::BufferDescriptor& androidDescriptor,
...
#endif  // ANDROID_HARDWARE_GRAPHICS_V3_X_GRALLOCBUFFERDESCRIPTOR_H
