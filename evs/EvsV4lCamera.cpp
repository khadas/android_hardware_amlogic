...
EvsV4lCamera::EvsV4lCamera(const char *deviceName,
   ...
   // mFormat = HAL_PIXEL_FORMAT_YCRCB_420_SP; //ww
    ...
    LOG(DEBUG) << "create EvsV4lCamera,mUsage:" << mUsage;
}
...
sp<EvsV4lCamera> EvsV4lCamera::Create(const char *deviceName,
    ...
    evsCamera->mUsage  = GRALLOC_USAGE_HW_TEXTURE | GRALLOC_USAGE_HW_RENDER |
                         GRALLOC_USAGE_SW_READ_MASK| GRALLOC_USAGE_SW_WRITE_MASK ;
    LOG(DEBUG) << "create,mUsage:" << evsCamera->mUsage;
    return evsCamera;
}
