...
//inline V41ErrorCode legacy_enum_conversion(const ErrorCode value) {
...
AmlogicKeymaster41Device::AmlogicKeymaster41Device(AmlogicKeymaster* impl) : impl_(impl) {}

AmlogicKeymaster41Device::~AmlogicKeymaster41Device() {}

Return<void> AmlogicKeymaster41Device::getHardwareInfo(getHardwareInfo_cb _hidl_cb) {
    _hidl_cb(SecurityLevel::TRUSTED_ENVIRONMENT, "AmlogicKeymaster", "Google");
    return Void();
}

Return<void> AmlogicKeymaster41Device::getHmacSharingParameters(
    ...
    V4_1::HmacSharingParameters params;
...
Return<void> AmlogicKeymaster41Device::computeSharedHmac(
...
Return<void> AmlogicKeymaster41Device::verifyAuthorization(
...
Return<ErrorCode> AmlogicKeymaster41Device::addRngEntropy(const hidl_vec<uint8_t>& data) {
...
Return<void> AmlogicKeymaster41Device::generateKey(const hidl_vec<KeyParameter>& keyParams,
...
Return<void> AmlogicKeymaster41Device::getKeyCharacteristics(const hidl_vec<uint8_t>& keyBlob,
...
Return<void> AmlogicKeymaster41Device::importKey(const hidl_vec<KeyParameter>& params,
                                               KeyFormat keyFormat,
...
Return<void> AmlogicKeymaster41Device::importWrappedKey(
...
Return<void> AmlogicKeymaster41Device::exportKey(KeyFormat exportFormat,
...
Return<void> AmlogicKeymaster41Device::attestKey(const hidl_vec<uint8_t>& keyToAttest,
...
Return<void> AmlogicKeymaster41Device::upgradeKey(const hidl_vec<uint8_t>& keyBlobToUpgrade,
...
Return<ErrorCode> AmlogicKeymaster41Device::deleteKey(const hidl_vec<uint8_t>& keyBlob) {
...
Return<ErrorCode> AmlogicKeymaster41Device::deleteAllKeys() {
...
Return<ErrorCode> AmlogicKeymaster41Device::destroyAttestationIds() {
...
Return<void> AmlogicKeymaster41Device::update(uint64_t operationHandle,
                                            const hidl_vec<KeyParameter>& inParams,
...
Return<void> AmlogicKeymaster41Device::finish(uint64_t operationHandle,
                                            const hidl_vec<KeyParameter>& inParams,
                                            const hidl_vec<uint8_t>& input,
...
Return<ErrorCode> AmlogicKeymaster41Device::abort(uint64_t operationHandle) {
...
Return<V41ErrorCode>
AmlogicKeymaster41Device::deviceLocked(bool passwordOnly,
                                       const VerificationToken& verificationToken) {
#if 1
...
#endif
    return static_cast<V41ErrorCode>(legacy_enum_conversion(
        impl_->DeviceLocked(DeviceLockedRequest(passwordOnly, std::move(serializableToken))).error));
}

Return<V41ErrorCode> AmlogicKeymaster41Device::earlyBootEnded() {
    return static_cast<V41ErrorCode>(legacy_enum_conversion(impl_->EarlyBootEnded().error));
}
