...
class AmlogicKeyMintOperation : public BnKeyMintOperation {
  public:
    explicit AmlogicKeyMintOperation(shared_ptr<AmlogicKeymaster> implementation,
                                    keymaster_operation_handle_t opHandle);
    virtual ~AmlogicKeyMintOperation();
