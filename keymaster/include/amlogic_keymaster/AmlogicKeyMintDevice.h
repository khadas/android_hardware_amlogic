...
class AmlogicKeyMintDevice : public BnKeyMintDevice {
  public:
    explicit AmlogicKeyMintDevice(shared_ptr<AmlogicKeymaster> impl) : impl_(std::move(impl)) {}
    virtual ~AmlogicKeyMintDevice() = default;
  ...
  protected:
    std::shared_ptr<AmlogicKeymaster> impl_;
