...
//using aidl::android::hardware::security::keymint::TrustyRemotelyProvisionedComponentDevice;
...
int main() {
    ...
    int err = KEYMASTER_TEMP_FAILURE_RETRY(amlKeymaster->Initialize(keymaster::KmVersion::KEYMINT_1), 1000);
    if (err != 0) {
