...
#define TAG AmlogicKeyMintDevice
...
#include <amlogic_keymaster/AmlogicKeyMintOperation.h>
...
ScopedAStatus AmlogicKeyMintDevice::addRngEntropy(const vector<uint8_t>& data) {
...
ScopedAStatus AmlogicKeyMintDevice::generateKey(const vector<KeyParameter>& keyParams,
...
ScopedAStatus AmlogicKeyMintDevice::getKeyCharacteristics(
...
ScopedAStatus AmlogicKeyMintDevice::importKey(const vector<KeyParameter>& keyParams,
...
ScopedAStatus AmlogicKeyMintDevice::importWrappedKey(const vector<uint8_t>& wrappedKeyData,
...
ScopedAStatus AmlogicKeyMintDevice::upgradeKey(const vector<uint8_t>& keyBlobToUpgrade,
...
ScopedAStatus AmlogicKeyMintDevice::deleteKey(const vector<uint8_t>& keyBlob) {
...
ScopedAStatus AmlogicKeyMintDevice::deleteAllKeys() {
...
ScopedAStatus AmlogicKeyMintDevice::destroyAttestationIds() {
    return kmError2ScopedAStatus(KM_ERROR_UNIMPLEMENTED);
}

ScopedAStatus AmlogicKeyMintDevice::begin(KeyPurpose purpose, const vector<uint8_t>& keyBlob,
    ...
    result->operation = ndk::SharedRefBase::make<AmlogicKeyMintOperation>(impl_, response.op_handle);
    return ScopedAStatus::ok();
}

ScopedAStatus AmlogicKeyMintDevice::deviceLocked(
...
ScopedAStatus AmlogicKeyMintDevice::earlyBootEnded() {
