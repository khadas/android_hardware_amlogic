...
::ndk::ScopedAStatus AmlogicSharedSecret::getSharedSecretParameters(SharedSecretParameters* params) {
...
::ndk::ScopedAStatus AmlogicSharedSecret::computeSharedSecret(
