...
#define ITEM_LOCK(pitems)\
    do{if(pitems->multi_threads_access)\
...
struct item *  itemlist_find_match_item_ex(struct itemlist *itemlist, struct item *tomatch, item_is_match_fun match, int reverse);
