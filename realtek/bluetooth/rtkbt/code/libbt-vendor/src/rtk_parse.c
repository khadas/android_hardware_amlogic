...
static void timeout_handler(int signo, siginfo_t *UNUSED(val) , void *UNUSED(val2))
{
...
static void udpsocket_receive_thread(void *UNUSED(val))
{
...
void rtk_add_le_profile(BD_ADDR UNUSED(bdaddr), uint16_t handle, uint8_t profile_map)
{
...
void rtk_delete_le_profile(BD_ADDR UNUSED(bdaddr), uint16_t handle, uint8_t profile_map)
{
