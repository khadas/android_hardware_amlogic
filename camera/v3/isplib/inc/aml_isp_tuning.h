...
typedef enum cali_type {
    ...
    CALIBRATION_FLCIKER_CTL               ,
    CALIBRATION_GTM                       ,
    CALIBRATION_DISP_GAMMA                ,
    CALIBRATION_DPC_ADJ                   ,
    CALIBRATION_GE_ADJ                    ,
    CALIBRATION_WDR_CTL                   ,
    ...
    CALIBRATION_SNR_PHS                   ,
    CALIBRATION_SNR_RAD_LUT65             ,
    CALIBRATION_PSNR_ADJ                  ,
    CALIBRATION_TNR_ADJ                   ,
    CALIBRATION_TNR_ALP_GLB_GAIN          ,
    CALIBRATION_TNR_SAD2ALPHA             ,
    CALIBRATION_MC_META2ALPHA             ,
    CALIBRATION_PTNR_ALP_LUT              ,
    ...
    CALIBRATION_PEAKING_BP_MOTION_ADP_GAIN,
    CALIBRATION_PEAKING_GAIN_VS_LUMA_LUT  ,
    CALIBRATION_PEAKING_CIR_HP_GAIN       ,
    CALIBRATION_PEAKING_CIR_BP_GAIN       ,
    CALIBRATION_PEAKING_DRT_HP_GAIN       ,
    CALIBRATION_PEAKING_DRT_BP_GAIN       ,
    CALIBRATION_CM_CTL                    ,
