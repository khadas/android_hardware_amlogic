...
int ge2dDevice::ge2d_scale(int dst_fd,int dst_fmt, size_t dst_w,size_t dst_h,
                                    int src_fd, int src_fmt, size_t src_w, size_t src_h) {
    ATRACE_CALL();
    ALOGVV("%s: E out %dx%d, in %dx%d", __FUNCTION__, dst_w, dst_h, src_w, src_h);
    aml_ge2d_t amlge2d;
    ...
    amlge2d.ge2dinfo.dst_info.format = dst_fmt; //PIXEL_FORMAT_YCbCr_420_SP_NV12;
