...
void cmos_get_sensor_gdc_parameter_imx585(struct sensorConfig *cfg, GDCInParam in_params,
...
{
    CAMHAL_LOGD("lxp8 cmos_again_calc_table: %d, %d\n", *pu32AgainLin, *pu32AgainDb);
    uint32_t again_reg;
    uint32_t u32AgainDb;
    ...
    //CAMHAL_LOGD("lxp7 set sensor reg value %d\n", again_reg);
