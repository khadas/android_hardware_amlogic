...
###
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.wifi@1.0-service-droidlogic-lib
...
###
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.wifi@1.0-service.droidlogic
LOCAL_VINTF_FRAGMENTS := android.hardware.wifi@1.0-service.droidlogic.xml
LOCAL_MODULE_RELATIVE_PATH := hw
LOCAL_PROPRIETARY_MODULE := true
LOCAL_CPPFLAGS := -Wall -Werror -Wextra
LOCAL_SRC_FILES := \
...
###
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.wifi@1.0-service.droidlogic-lazy
LOCAL_VINTF_FRAGMENTS := android.hardware.wifi@1.0-service.droidlogic.xml
LOCAL_OVERRIDES_MODULES := android.hardware.wifi@1.0-service.droidlogic
