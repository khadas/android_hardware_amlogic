...
// Copies wifi_peer_info* to vector<WifiPeerInfo> and returns pointer to next element.
...
// Copies wifi_link_stat* to vector<LinkStats> and returns pointer to next element.
