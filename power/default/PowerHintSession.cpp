...
namespace aidl::hardware::power::impl::droidlogic {

using ndk::ScopedAStatus;

PowerHintSession::PowerHintSession(int32_t tgid __unused, int32_t uid __unused,
                                    const std::vector<int32_t> &threadIds __unused,
                                    int64_t durationNanos __unused) {}
