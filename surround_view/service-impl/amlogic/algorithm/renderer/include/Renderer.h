...
public:
    Renderer(sp<GraphicBuffer> frameBuffer);

    int SetViewPort(ViewPort viewPort);
    int SetCameraData(TextureInfo *textInfos, size_t num);
    int SetCarInfo(CarInfo *carInfos, size_t num);
    int SetCarModel(TextureInfo *carModel, size_t num);
