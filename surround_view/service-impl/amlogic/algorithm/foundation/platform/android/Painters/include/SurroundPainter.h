...
#ifndef SURROUND_PAINTER_H
#define SURROUND_PAINTER_H

#include "TexturePainter.h"

class SurroundPainter : public TexturePainter {
public:
    SurroundPainter();
    const char* TextureName();

private:
    DISALLOW_COPY_AND_ASSIGN(SurroundPainter);
};

#endif // SURROUND_PAINTER_H
