...
#define LOG_TAG "BasePainter"

#include "include/BasePainter.h"


int BasePainter::InitDatas() {
    return RESULT_OK;
}

int BasePainter::DeinitDatas() {
    return RESULT_OK;
}

GLenum BasePainter::InitGL() {
    return GL_NO_ERROR;
}

GLenum BasePainter::DeinitGL() {
    return GL_NO_ERROR;
}

int BasePainter::SetParams(const char *type, ...) {
    LOGW("unsupport the type: %s", type);
    return RESULT_OK;
}

GLenum BasePainter::Prepare() {
    return GL_NO_ERROR;
}

GLenum BasePainter::Draw() {
    return GL_NO_ERROR;
}

GLenum BasePainter::Complete() {
    return GL_NO_ERROR;
}
